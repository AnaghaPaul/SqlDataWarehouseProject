...
-- Total revenue generated by customers grouped by their first purchase month, tracked over subsequent months.
-- -----------------------------------------------------------------------------------------------------------
-- Definitions :
-- Month offset : Month offset represents the number of months that have passed between a user's initial action i.e first purchase and a subsequent event i.e second purchase
-- Month offset = (Invoice Year- Cohort Year) * 12 + (Invoice month - Cohort Month)
-- M0 : Total revenue generated by a cohort in the same month as their first purchase (acquisition month).
-- Includes: First purchase + Any additional purchases within that same month
-- It is a period total
-- M1,M2...Mn :Total revenue generated by the cohort n months after their acquisition month.
-- Each Mn is: A separate time bucket, Not cumulative, Independent of other months
